  ...
  return (
    <>
      <div className="w-full max-w-xl mx-auto my-4 bg-white/80 rounded-xl shadow-md p-4 transition-all duration-300 animate-toggle-fade-in">
        <button
          onClick={handlePageSpecification}
        ...
        >
          <span className="inline-block">Page Specification</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`w-5 h-5 ml-2 transform transition-transform duration-300 ${isPageSpecificationOpen ? 'rotate-180' : 'rotate-0'}`}
            viewBox="0 0 448 512"
          >
        ...
        <div
          className={`overflow-hidden transition-all duration-500 ${isPageSpecificationOpen ? 'max-h-[600px] opacity-100 mt-4' : 'max-h-0 opacity-0 mt-0'}`}
        >
...
export default PageSpecification