      ...
      <aside className="w-52 border-r-2 border-slate-50 ">
        <div className="  h-screen border-r-slate-900 ">
          <div className="ml-5">
            ...
            <br />
            <button className="ml-3 mt-1 flex gap-2" onClick={handleParseClick}>
              <svg
          ...
          <div className="ml-5 mt-3">
            <span className="font-light">Contacts</span> <br />
            <button
              className="ml-3 mt-1 flex gap-2 justify-center items-center"
            ...
            <button className="ml-3 mt-1 flex gap-2 justify-center items-center">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
            ...
            <button className="ml-3 mt-1 flex gap-2 justify-center items-center">
              ...
              <a href="https://github.com/Gautam-Poriya" target="_blank">
                GitHub
              </a>
            </button>
          </div>
