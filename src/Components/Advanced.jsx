        ...
        <div className="w-full max-w-xl mx-auto my-4 bg-white/80 rounded-xl shadow-md p-4 transition-all duration-300 animate-toggle-fade-in">
          ...
          >
            ...
            <svg
              ...
              className={`w-5 h-5 ml-2 transform transition-transform duration-300 ${isAdvancedIsOpen ? 'rotate-180' : 'rotate-0'}`}
              viewBox="0 0 448 512"
            >
          ...
          <div
            className={`overflow-hidden transition-all duration-500 ${isAdvancedIsOpen ? 'max-h-[600px] opacity-100 mt-4' : 'max-h-0 opacity-0 mt-0'}`}
          >
